#!/bin/bash
# EmoBrain — swift_NewE96_SL20, sub-05 only (6 leaf: 2 init x 3 padding)
...
LEAFS=("${LEAF_DIR}"/swift_NewE96_SL20_*_sub-05.sh)
TOTAL="${#LEAFS[@]}"
COUNT=0
START_ALL=$(date +%s)

echo "============================================================"
echo "${MODEL_TAG} sub-05 extraction (${TOTAL} runs)"
echo "Start: $(date)"
echo "============================================================"
...
END_ALL=$(date +%s)
echo "============================================================"
echo "${MODEL_TAG} sub-05 done. Total: $((END_ALL - START_ALL))s"
echo "============================================================"
