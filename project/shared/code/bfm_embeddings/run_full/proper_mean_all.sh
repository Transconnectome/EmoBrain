...
#
# 사용법:
#   bash /pscratch/sd/s/sjmoon/FEELIN/project/shared/code/bfm_embeddings/run_full/proper_mean_all.sh
#
...
RUN_FULL=/pscratch/sd/s/sjmoon/FEELIN/project/shared/code/bfm_embeddings/run_full
