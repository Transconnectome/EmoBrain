...
# Model: SwiFT_NewE96 (config_set=main).  Task: A_reg.
...
/pscratch/sd/s/sjmoon/swift_PTL2/bin/python code/probes/run_unified_probe.py \
    ...
    --tasks A_reg \
    --out_csv results/phase1/bfm_probe_SwiFT_NewE96_A_reg.csv \
    --summary_csv results/phase1/bfm_probe_SwiFT_NewE96_A_reg_summary.csv
