#!/bin/bash
# SwiFT_UAH_51M frozen probe: Valence continuous regression. Padding=zero (variants extracted with zero).
...
/pscratch/sd/s/sjmoon/swift_PTL2/bin/python code/probes/run_unified_probe.py \
    ...
    --tasks V_reg \
    --out_csv "results/phase1/bfm_probe_SwiFT_UAH_51M_${PADDING}_V_reg.csv" \
    --summary_csv "results/phase1/bfm_probe_SwiFT_UAH_51M_${PADDING}_V_reg_summary.csv"
