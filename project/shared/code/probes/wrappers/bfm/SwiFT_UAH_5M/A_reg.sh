#!/bin/bash
# SwiFT_UAH_5M frozen probe: Arousal continuous regression. Padding=zero (variants extracted with zero).
...
/pscratch/sd/s/sjmoon/swift_PTL2/bin/python code/probes/run_unified_probe.py \
    ...
    --tasks A_reg \
    --out_csv "results/phase1/bfm_probe_SwiFT_UAH_5M_${PADDING}_A_reg.csv" \
    --summary_csv "results/phase1/bfm_probe_SwiFT_UAH_5M_${PADDING}_A_reg_summary.csv"
