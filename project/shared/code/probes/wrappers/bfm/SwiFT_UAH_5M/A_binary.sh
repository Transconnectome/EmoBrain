#!/bin/bash
# SwiFT_UAH_5M frozen probe: Arousal extreme binary. Padding=zero (variants extracted with zero).
...
/pscratch/sd/s/sjmoon/swift_PTL2/bin/python code/probes/run_unified_probe.py \
    ...
    --tasks A_binary \
    --out_csv "results/phase1/bfm_probe_SwiFT_UAH_5M_${PADDING}_A_binary.csv" \
    --summary_csv "results/phase1/bfm_probe_SwiFT_UAH_5M_${PADDING}_A_binary_summary.csv"
