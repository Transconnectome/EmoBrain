...
Outputs PNG (300 DPI) to /pscratch/sd/s/sjmoon/FEELIN/project/shared/results/background/padding_ablation/figures/
"""
...
ROOT = Path("/pscratch/sd/s/sjmoon/FEELIN/project/shared/results/background/padding_ablation")
OUT = ROOT / "figures"
