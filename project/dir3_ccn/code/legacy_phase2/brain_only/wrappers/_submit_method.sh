...
#SBATCH --output=/pscratch/sd/s/sjmoon/EmoBrain/project/shared/output/slurm/p2_brainonly_%x_%j.out
#SBATCH --error=/pscratch/sd/s/sjmoon/EmoBrain/project/shared/output/slurm/p2_brainonly_%x_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
WRAP_DIR=/pscratch/sd/s/sjmoon/EmoBrain/project/dir2_multimodal/code/legacy_phase2/brain_only/wrappers/${METHOD}
