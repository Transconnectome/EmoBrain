...
#SBATCH --output=/pscratch/sd/s/sjmoon/EmoBrain/project/dir3_ccn/study1/logs/exp30_%j.out
#SBATCH --error=/pscratch/sd/s/sjmoon/EmoBrain/project/dir3_ccn/study1/logs/exp30_%j.err
