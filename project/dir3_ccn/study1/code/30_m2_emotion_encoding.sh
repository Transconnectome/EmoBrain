...
#SBATCH --output=/pscratch/sd/s/sjmoon/FEELIN/project/dir3_ccn/study1/logs/exp30_%x_%j.out
#SBATCH --error=/pscratch/sd/s/sjmoon/FEELIN/project/dir3_ccn/study1/logs/exp30_%x_%j.err
