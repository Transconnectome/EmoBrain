...
#
# Sbatch wrapper. Horikawa Emotion VA_binary 본 학습 (50 epoch, 전체 데이터).
# 본 학습 entry script (interactive bash 형식) 을 sbatch 환경에서 실행.
# 사용 = sbatch sbatch_horikawa_emotion_va_binary.sh
#
...
bash ${D1}/sample_scripts/UMBRELLA_ROI_Horikawa_Emotion_VA_binary_icl_3subj_3stim.sh
