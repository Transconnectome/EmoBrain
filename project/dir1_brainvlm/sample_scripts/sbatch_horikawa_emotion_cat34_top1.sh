...
#
# Sbatch wrapper. Horikawa Emotion Cat34_top1 본 학습 (50 epoch, 전체 데이터).
# 본 학습 entry script (interactive bash 형식) 을 sbatch 환경에서 실행.
# 사용 = sbatch sbatch_horikawa_emotion_cat34_top1.sh
#
...
bash ${D1}/sample_scripts/UMBRELLA_ROI_Horikawa_Emotion_Cat34_top1_icl_3subj_3stim.sh
