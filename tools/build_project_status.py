#!/usr/bin/env python3
"""Build a compact EmoBrain project status report."""
...
- Dataset entries in `docs/reference/datasets.md`: {dataset_count}
- Approximate paper table rows in `docs/reference/papers.md`: {paper_rows}
- Approximate code-resource table rows in `docs/reference/code_resources.md`: {model_rows}
