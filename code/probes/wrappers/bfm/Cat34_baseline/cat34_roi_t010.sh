...
#SBATCH --output=/pscratch/sd/s/sjmoon/FEELIN/output/slurm/cat34_baseline/cat34_roi_t010_%j.out
#SBATCH --error=/pscratch/sd/s/sjmoon/FEELIN/output/slurm/cat34_baseline/cat34_roi_t010_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
/pscratch/sd/s/sjmoon/swift_PTL2/bin/python /pscratch/sd/s/sjmoon/FEELIN/code/probes/run_unified_probe.py \
    ...
    --seeds 0 \
    --skip_mlp \
    --out_csv /pscratch/sd/s/sjmoon/FEELIN/results/background/phase1/cat34_probe_ROI_linear_t010.csv \
    --summary_csv /pscratch/sd/s/sjmoon/FEELIN/results/background/phase1/cat34_probe_ROI_linear_t010_summary.csv
