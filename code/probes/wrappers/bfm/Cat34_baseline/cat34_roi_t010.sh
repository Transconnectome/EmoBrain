...
/pscratch/sd/s/sjmoon/swift_PTL2/bin/python /pscratch/sd/s/sjmoon/FEELIN/code/probes/run_unified_probe.py \
    ...
    --seeds 0 \
    --skip_mlp \
    --out_csv /pscratch/sd/s/sjmoon/FEELIN/results/phase1/cat34_probe_ROI_linear_t010.csv \
    --summary_csv /pscratch/sd/s/sjmoon/FEELIN/results/phase1/cat34_probe_ROI_linear_t010_summary.csv
