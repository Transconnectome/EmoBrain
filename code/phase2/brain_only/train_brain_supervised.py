...
class BrainMLP(nn.Module):
    def __init__(self, brain_dim, n_out, task_type, hidden=256, dropout=0.3):
        super().__init__()
...
def build_brain_data(brain_dict, label_df, split_df, task_type):
    """Pooled brain-only data. Same logic as _lib.build_pooled_data but brain-only."""
