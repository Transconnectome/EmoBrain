...
```
code/dir2_multimodal/legacy_phase2/
├── README.md
...
bash code/dir2_multimodal/legacy_phase2/wrappers/D/V_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/D/A_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/D/V_reg.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/D/A_reg.sh

# A (PyTorch, ~20-50s/fold/seed, 5 folds × 3 seeds = 15 runs)
bash code/dir2_multimodal/legacy_phase2/wrappers/A/V_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/A/A_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/A/V_reg.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/A/A_reg.sh

# B (PyTorch, ~15-30s/fold/seed)
bash code/dir2_multimodal/legacy_phase2/wrappers/B/V_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/B/A_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/B/V_reg.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/B/A_reg.sh
```
...
bash code/dir2_multimodal/legacy_phase2/wrappers/C/stage1_align.sh

# Stage 2: linear probe (after Stage 1 ckpts exist)
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_brain_only/V_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_brain_only/A_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_brain_only/V_reg.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_brain_only/A_reg.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_joint/V_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_joint/A_binary.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_joint/V_reg.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/C/probe_joint/A_reg.sh
```

### 3. Direction 2 (encoding)

```bash
bash code/dir2_multimodal/legacy_phase2/wrappers/encoding/clip_pretrained.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/encoding/vjepa2_pretrained.sh
bash code/dir2_multimodal/legacy_phase2/wrappers/encoding/dinov2_pretrained.sh
```
