...
def main():
    ...
    ap.add_argument("--config", default=str(FEELIN / "code/brainvlm/config_feelin_fold1_VA.yaml"))
    ap.add_argument("--conv_root", default=str(FEELIN / "output/brainvlm_conversations/pad-zero_VA"))
    ...
    out_default = FEELIN / "output/brainvlm_ckpt" / f"fold{args.fold}_VA_smoke"
