...
\begin{itemize}[leftmargin=*, itemsep=2pt]
  ...
  \item \texttt{Cat34\_multilabel}. 각 자극의 34 category score 가 threshold 0.15 이상이면 양성. 평균 자극당 4.19 category 가 양성. per-category L2 logistic $\times$ 34. main metric category-wise AUROC 의 macro 평균.
...
\input{table_V_binary.tex}

\input{table_A_binary.tex}

\input{table_V_reg.tex}

\input{table_A_reg.tex}

\input{table_Cat34.tex}
