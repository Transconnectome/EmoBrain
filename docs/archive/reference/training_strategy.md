...
old 5TR subset came from a legacy loader/split constraint. FEEL should use
...
FEEL should test which neural representation is useful for emotion rather
...
The first FEEL decoding result should therefore be a length-aware screening
...
| Use mode | Input | Output | FEEL role |
|---|---|---|---|
