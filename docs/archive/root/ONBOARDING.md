...
> **SUPERSEDED 2026-08-17 — LLM backbone removed.** Current direction:
> `docs/direction_v6_labelquery_20260817.md` (LLM-free label-query decoder; novelty
> = open-vocabulary emotion decoding FROM BRAIN + cross-dataset transfer). The
> Qwen3-VL-4B / NV0-NV4 framing below is historical.
