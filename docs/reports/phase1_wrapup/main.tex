...
\begin{figure}[h]
\centering
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{figs/ranking_V_binary.png}\caption{V\_binary}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{figs/ranking_A_binary.png}\caption{A\_binary}\end{subfigure}\\[4pt]
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{figs/ranking_V_reg.png}\caption{V\_reg}\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}\includegraphics[width=\linewidth]{figs/ranking_A_reg.png}\caption{A\_reg}\end{subfigure}
...
\begin{verbatim}
bash /pscratch/sd/s/sjmoon/EmoBrain/project/shared/code/bfm_embeddings/\
