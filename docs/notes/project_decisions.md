...
**영향**.
- `code/probes/run_unified_probe.py:147`, `code/probes/run_chance_cat34.py:41`, `project/dir2_multimodal/code/legacy_phase2/_lib.py:41` 의 `CAT34_MULTILABEL_THRESHOLD` 변경.
...
**결정**. Cat34_multilabel + Cat34_soft 의 ROI baseline 과 chance baseline 이 phase 1 launch 에서 누락된 점 발견. 보강 launch (`cat34_roi.sh` + `cat34_chance.sh`). 코드 `code/probes/run_chance_cat34.py` 신설.
