...
이 question 은 model design 의 question 이 아니다. Foundation model = *answering instrument*. Decoding ceiling 자체 = inter-rater concordance (Cowen-Keltner 2017, ICC ≈ 0.54). Brain unique contribution 자체 = modality variance partitioning 의 unique-brain term. 둘 다 *measure-able neuroscientific quantity*.
...
- **(a) Affect decoding ceiling.** Cowen-Keltner inter-rater ICC 0.54 의 ceiling 대비 brain decoding 이 얼마까지 도달 가능 한가. 도달 못 한다 면 그 *gap* 의 nature 는 무엇인가 (noise vs irreducible individual difference vs missing modality).
...
Cowen-Keltner 2017 PNAS 의 inter-rater ICC ≈ 0.54 (34-category mean). Single video 의 affect rating 의 *human-human agreement* 의 upper limit. 이 ceiling 은 *task irreducible noise* 의 quantity. Brain decoding 의 absolute ceiling.
