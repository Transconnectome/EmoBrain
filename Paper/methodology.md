...
| REELMO | stimulus-side affect supervision; fMRI participants watched Jojo Rabbit | time-resolved affect reports | check BIDS access and Jojo Rabbit annotation alignment |
...
| REELMO | time-resolved affect reports; fMRI participants watched Jojo Rabbit | optional | planned | limited one-movie fMRI | optional | stimulus-side supervision |
